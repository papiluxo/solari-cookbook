...
| [vpi-solari](examples/vpi-solari) | Python | Production price collector behind a Cloudflare challenge: whole-store listing crawl, stealth + Turnstile click, replay per run |
